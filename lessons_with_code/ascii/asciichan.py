...
class Art(db.Model):
	# how you say something is a particular type StringProperty means it's a string type
	# required = True: if we try to make an instance of art without giving a title or art
...
class MainPage(Handler):
	...
	def post(self):
		...
		if title and art:
			...
			a.put() # store new art object into database
			self.redirect("/")
		else:
